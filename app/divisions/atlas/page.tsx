...
export const metadata: Metadata = {
  title: "ATLAS Division — Commercial Real Estate Intelligence",
  description:
    "ATLAS applies COSMIC to commercial real estate: mineral rights, property graph intelligence, and NAUTILUS portfolio analysis.",
};
        ...
        <div style={S.container}>
          <div style={{ maxWidth: 680 }}>
            ...
            <p style={{ fontSize: "1.0625rem", color: "var(--text-secondary)", lineHeight: 1.7, maxWidth: 560 }}>
              ATLAS applies the COSMIC reasoning substrate to commercial real estate — mineral rights
              analysis, property graph reconstruction, and portfolio-scale deal intelligence.
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(280px, 1fr))", gap: "1px", backgroundColor: "var(--bg-border)", border: "1px solid var(--bg-border)" }}>
            {[
              ...
              },
              {
                ...
                description: "Portfolio-scale deal intelligence — lease abstraction, comps analysis, and capital structure modeling. Built on ATLAS's property graph foundation.",
                vantage: "—",
              },
            ].map((product) => (
      ...
      <section style={{ padding: "5rem 0" }}>
        <div style={S.containerSm}>
          ...
          <p style={S.p}>
            ...
            a minor inaccuracy — it is the basis of a title dispute worth millions.
          </p>
