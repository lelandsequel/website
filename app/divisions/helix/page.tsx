...
export const metadata: Metadata = {
  ...
  description:
    "HELIX applies COSMIC to healthcare workflow automation. HELIX is in TestFlight. PHAROS is in development.",
};
    ...
    <>
        ...
        <div style={S.container}>
          <div style={{ maxWidth: 680 }}>
            ...
            <p style={{ fontSize: "1.0625rem", color: "var(--text-secondary)", lineHeight: 1.7, maxWidth: 560 }}>
              HELIX applies the COSMIC reasoning substrate to healthcare workflow — clinical routing,
              documentation assistance, and pharmacovigilance-grade signal detection.
              Built for the regulatory reality of healthcare, not against it.
            </p>
          </div>
        </div>
      </section>
            ...
            {[
              {
                name: "HELIX",
                status: "TestFlight",
                description: "Clinical workflow automation application. Task routing, documentation triage, and care coordination support. Currently in TestFlight evaluation with clinical partners.",
                vantage: "81.5%",
              },
              {
                name: "PHAROS",
                status: "In development",
                description: "Pharmacovigilance signal detection for clinical environments. Built on the SIGNAL benchmark research track. Designed for regulatory submission requirements.",
                vantage: "—",
              },
            ].map((product) => (
      ...
      <section style={{ padding: "5rem 0" }}>
        <div style={S.containerSm}>
          <span style={S.label}>Healthcare requires honest refusal</span>
          <p style={S.p}>
            Healthcare AI that guesses confidently about clinical decisions is not better than no AI —
            it is actively dangerous. The AURORA confidence gate is especially important in clinical contexts:
            HELIX refuses to route or classify when aggregate confidence falls below threshold, surfacing
            the ambiguous case to a human clinician rather than emitting a verdict.
          </p>
          <p style={{ ...S.p, marginBottom: "2rem" }}>
            PHAROS extends this posture to pharmacovigilance: adverse drug event signals require
            SHA-verified chain of custody from source document to regulatory submission.
            The same architecture that powers the SIGNAL benchmark powers PHAROS.
          </p>
