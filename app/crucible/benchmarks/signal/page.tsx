        ...
        <section style={{ marginBottom: "3rem" }}>
          ...
          <div style={{ borderLeft: "2px solid var(--bg-border)", paddingLeft: "1.5rem" }}>
            <p style={S.p}>
              ...
              contains spontaneous reports with highly variable text quality. The pipeline performs significantly
              better on structured reporter-written narratives than on consumer-submitted reports.
            </p>
            <p style={S.p}>
