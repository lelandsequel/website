...
const S: Record<string, React.CSSProperties> = {
  ...
  step: { display: "flex", gap: "1.25rem", marginBottom: "1.5rem", alignItems: "flex-start" },
  stepNum: { fontFamily: "var(--font-geist-mono), monospace", fontSize: "0.75rem", fontWeight: 700, color: "var(--accent)", width: 24, flexShrink: 0, paddingTop: "0.1rem" },
};
