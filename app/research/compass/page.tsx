        ...
        <section style={{ marginBottom: "3rem" }}>
          ...
          <div style={{ borderLeft: "2px solid var(--bg-border)", paddingLeft: "1.5rem" }}>
            <p style={S.p}>
              ...
              category is documented in the repo and is lower. Within-1-tier is the operationally relevant
              metric for most use cases but should not be compared to exact-match results from other systems.
            </p>
            <p style={S.p}>
