      ...
      <div style={S.container}>
        ...
        <div style={{ border: "1px solid var(--accent-border)", borderLeft: "2px solid var(--accent)", padding: "1rem 1.25rem", backgroundColor: "var(--accent-dim)", marginBottom: "3rem" }}>
          <p style={{ color: "var(--text-secondary)", fontSize: "0.875rem", margin: 0, lineHeight: 1.6 }}>
            ...
            at time of publication. If v0.4 P@5 exceeds 0.25, this page will be updated with the final sealed
            number. The 25× grep advantage figure comes from v0.3 intent-query evaluation and is conservatively
            stated — v0.4 results may revise upward.
          </p>
        </div>
        ...
        <section style={{ marginBottom: "3rem" }}>
          ...
          <p style={S.p}>
            The 25× advantage over grep is measured on intent queries — queries where the user's information
            need cannot be expressed as a literal string match. On exact-string queries, LENS and grep perform
            comparably. The benchmark is honest about this: grep wins on exact matches; LENS wins on everything
            else.
          </p>
        </section>
        ...
        <section style={{ marginBottom: "3rem" }}>
          ...
          <div style={{ borderLeft: "2px solid var(--bg-border)", paddingLeft: "1.5rem" }}>
            ...
            <p style={{ ...S.p, marginBottom: 0 }}>
              ...
              contribution of each pipeline stage (retrieval vs. scoring vs. AURORA gate) has not been
              published as a separate ablation. Full methodology documented in the repo.
            </p>
          </div>
        </section>
