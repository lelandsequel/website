...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/cipher", destination: "/alchemist/cipher", permanent: true },
      { source: "/comps", destination: "/alchemist/comps", permanent: true },
      { source: "/alchemist/models", destination: "/alchemist/banking", permanent: true },
      { source: "/finance-models", destination: "/alchemist/banking", permanent: true },
      { source: "/finance-models/cipher-dcf", destination: "/alchemist/cipher", permanent: true },
      { source: "/finance-models/dcf", destination: "/alchemist/cipher", permanent: true },
      { source: "/finance-models/comps", destination: "/alchemist/comps", permanent: true },
      { source: "/finance-models/credit", destination: "/alchemist/models/credit", permanent: true },
      { source: "/finance-models/:path*", destination: "/alchemist/banking", permanent: true },
      ...
      { source: "/muninn", destination: "/benchmarks/muninn", permanent: true },
      {
        ...
        destination:
          "https://1ggaswfydmbvwook.public.blob.vercel-storage.com/downloads/OMNIS-Mac-0.1.4.dmg",
        permanent: false,
      },
      {
        source: "/downloads/OMNIS-Mac-0.1.0.dmg.sha256.txt",
        destination:
          "https://1ggaswfydmbvwook.public.blob.vercel-storage.com/downloads/OMNIS-Mac-0.1.4.dmg.sha256.txt",
        permanent: false,
      },
      {
      ...
      {
        source: "/downloads/OMNIS-Mac-0.1.4.dmg",
        destination:
          "https://1ggaswfydmbvwook.public.blob.vercel-storage.com/downloads/OMNIS-Mac-0.1.4.dmg",
        permanent: false,
      },
      {
        source: "/downloads/OMNIS-Mac-0.1.4.dmg.sha256.txt",
        destination:
          "https://1ggaswfydmbvwook.public.blob.vercel-storage.com/downloads/OMNIS-Mac-0.1.4.dmg.sha256.txt",
        permanent: false,
      },
